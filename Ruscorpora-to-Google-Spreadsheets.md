...
Сначала, конечно, __нужно задать запрос__. Для этого идём в корпус Araneum Anglicum и в разделе [поиска](http://ucts.uniba.sk/guest/run.cgi/first_form?corpname=AranAngl_x;align=) задаём наш запрос: *[word=".\*ica?l?" & tag="JJ"]*.
